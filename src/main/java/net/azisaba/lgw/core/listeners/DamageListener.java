...
public class DamageListener implements Listener {
  ...
  public void onKill(PlayerDeathEvent e) {
    ...
    Bukkit.getScheduler()
        .runTaskLater(
            ...
            () -> killer.sendTitle("", Chat.f("&b{0} &7Kill Streaks", streaks), 0, 20, 20),
            20);
    // 音を鳴らす
            ...
            assist -> {
              ...
              Bukkit.getScheduler()
                  .runTaskLater(
                      ...
                      () ->
                          assist.sendTitle(
                              "", Chat.f("&a{0} &7Assist Streaks", streaks), 0, 20, 20),
                      20);
              // 音を鳴らす
  ...
  public void deathMessageChanger(PlayerDeathEvent e) {
    ...
    String msg =
        Chat.f(
            "{0}&r{1} &7━━━ [ &r{2} &7] ━━━> &r{3}",
            LeonGunWar.GAME_PREFIX, killer.getDisplayName(), itemName, p.getDisplayName());
